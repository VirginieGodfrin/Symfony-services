...
class Genus extends \AppBundle\Entity\Genus implements \Doctrine\ORM\Proxy\Proxy
{
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return ['__isInitialized__', '' . "\0" . 'AppBundle\\Entity\\Genus' . "\0" . 'id', '' . "\0" . 'AppBundle\\Entity\\Genus' . "\0" . 'name', '' . "\0" . 'AppBundle\\Entity\\Genus' . "\0" . 'subFamily', '' . "\0" . 'AppBundle\\Entity\\Genus' . "\0" . 'speciesCount', '' . "\0" . 'AppBundle\\Entity\\Genus' . "\0" . 'funFact', '' . "\0" . 'AppBundle\\Entity\\Genus' . "\0" . 'isPublished', '' . "\0" . 'AppBundle\\Entity\\Genus' . "\0" . 'notes'];
        }
