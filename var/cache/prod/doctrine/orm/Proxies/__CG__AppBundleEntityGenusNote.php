...
class GenusNote extends \AppBundle\Entity\GenusNote implements \Doctrine\ORM\Proxy\Proxy
{
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return ['__isInitialized__', '' . "\0" . 'AppBundle\\Entity\\GenusNote' . "\0" . 'id', '' . "\0" . 'AppBundle\\Entity\\GenusNote' . "\0" . 'username', '' . "\0" . 'AppBundle\\Entity\\GenusNote' . "\0" . 'userAvatarFilename', '' . "\0" . 'AppBundle\\Entity\\GenusNote' . "\0" . 'note', '' . "\0" . 'AppBundle\\Entity\\GenusNote' . "\0" . 'createdAt', '' . "\0" . 'AppBundle\\Entity\\GenusNote' . "\0" . 'genus'];
        }
    ...
    public function getUserAvatarFilename()
    {
        ...
        $this->__initializer__ && $this->__initializer__->__invoke($this, 'getUserAvatarFilename', []);
    ...
    public function setUserAvatarFilename($userAvatarFilename)
    {
        ...
        $this->__initializer__ && $this->__initializer__->__invoke($this, 'setUserAvatarFilename', [$userAvatarFilename]);
